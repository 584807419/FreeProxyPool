...
BASE_URL = 'http://proxygather.com/zh/proxylist/port/9999'


class Proxygather9999Crawler(BaseCrawler):
    urls = [BASE_URL]
    data = {
        'Filter': '',
        'Uptime': '99',
    ...
    def parse(self, html_content):
        for i in html.fromstring(html_content).xpath('//div[@class="proxy-list"]/table/tr/td/script/text()'):
            ...
            if len(ip) > 4:
                yield Proxy(host=ip, port='9999')


if __name__ == '__main__':
    crawler = Proxygather9999Crawler()
