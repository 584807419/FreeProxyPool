...
BASE_URL = 'http://proxygather.com/zh/proxylist/port/8888'


class Proxygather8888Crawler(BaseCrawler):
    urls = [BASE_URL]
    data = {
        'Filter': '',
        'Uptime': '50',
    ...
    def parse(self, html_content):
        for i in html.fromstring(html_content).xpath('//div[@class="proxy-list"]/table/tr/td/script/text()'):
            ...
            if len(ip) > 4:
                yield Proxy(host=ip, port='8888')


if __name__ == '__main__':
    crawler = Proxygather8888Crawler()
