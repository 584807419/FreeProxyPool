...
BASE_URL = 'http://proxygather.com/zh/proxylist/port/3129'


class Proxygather3129Crawler(BaseCrawler):
    urls = [BASE_URL]
    data = {
        'Filter': '',
        'Uptime': '50',
    ...
    def parse(self, html_content):
        for i in html.fromstring(html_content).xpath('//div[@class="proxy-list"]/table/tr/td/script/text()'):
            ...
            if len(ip) > 4:
                yield Proxy(host=ip, port='3129')


if __name__ == '__main__':
    crawler = Proxygather3129Crawler()
