...
#
# BASE_URL = 'https://www.sunjs.com/proxy/list.html'
#
#
...
#         for ele in html.fromstring(html_content).xpath('//table[@class="table table-bordered table-striped"]/tbody/tr/td[2]'):
#             print(ele.xpath('script/text'))
#         #
#         #
